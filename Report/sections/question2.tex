...
posterior probability. Using Bayes' theorem \parencite{gareth2023introduction}:
...
\begin{enumerate}[label=\roman*.]
    ...
    \item The estimated discriminant functions of the fitted model in terms of $X_1$ and $X_2$ was obtained
          ...
          \begin{align*}
            ...
            +\log(0.2466)
            \\[1em]
            &\underrightarrow{=-263.7093 + 2.6608X_1 + 2.5878X_2}.
          \end{align*}
          \begin{align*}
            \delta_2(X)
            &=
            ...
            +\log(0.3474)
            \\[1em]
            &\underrightarrow{=-302.7819 + 3.0268X_1 + 2.5986X_2}.
          \end{align*}
          \begin{align*}
            \delta_3(X)
            &=
            ...
            +\log(0.4060)
            \\[1em]
            & \underrightarrow{= -333.1869 + 2.4766X_1 + 3.3973X_2}.
          \end{align*}
...
\begin{enumerate}[label=\roman*.]
    ...
    \item Thereafter, a GMM model with 3 components was fitted using the \emph{GaussianMixture}
          ...
          \begin{table}[h]
            ...
            2 & 111.0364 & 106.0356 & 4.0027 & 4.0317 & 0.2972 \\
            3 & 104.8763 & 120.0094 & 4.9881 & 4.3945 & 0.4028 \\
            \hline
            \end{tabular}
          ...
          \begin{table}[h]
            ...
            2 & 110.6269 & 105.6018 & 4.5360 & 4.5226 & 0.2896 \\
            3 & 104.6707 & 119.6564 & 5.0813 & 4.7909 & 0.4129 \\
            \hline
            \end{tabular}
...
\begin{enumerate}[label=\roman*.]
    ...
    \item Thereafter, a GMM model with 4 components was fitted using the \emph{GaussianMixture}
          ...
          \begin{table}[h]
            ...
            Component & Mean $X_1$ & Mean $X_2$ & SD $X_1$ & SD $X_2$ & Mixing Proportion \\
            \hline
            1 & 99.8886  & 98.5331  & 4.6618 & 4.3288 & 0.2772 \\
            2 & 111.2671 & 105.8966 & 3.8095 & 3.9774 & 0.2869 \\
            3 & 100.7348 & 115.4825 & 3.4678 & 3.8975 & 0.2055 \\
            4 & 107.8834 & 122.4818 & 3.8208 & 3.6457 & 0.2303 \\
            \hline
            \end{tabular}
          ...
          \begin{table}[h]
            ...
            Component & Mean $X_1$ & Mean $X_2$ & SD $X_1$ & SD $X_2$ & Mixing Proportion \\
            \hline
            1 & 100.6293 & 99.4669  & 5.4124 & 5.0472 & 0.2932 \\
            2 & 110.6256 & 105.6406 & 4.5479 & 4.4650 & 0.2866 \\
            3 & 101.2129 & 116.7777 & 3.9741 & 4.4752 & 0.1875 \\
            4 & 107.3547 & 121.6554 & 4.1547 & 4.1872 & 0.2327 \\
            \hline
            \end{tabular}
...
results seen in Table \ref{tab:gmm_class_metrics} for the GMM model with 3 components. The main reason has to do with the fact that the LDA
model was a supervised model which knew the group labels during training. Both models were able to identify group 3 very well but often confused true group 2 points as
group 1 instead and vice versa. This can be seen by the plot of the original data:

\begin{figure}[h]
  \centering
  \includegraphics[width=0.65\textwidth]{images/original.png}
  \caption{Split of the combined input data}
  \label{fig:original}
\end{figure}

Figure \ref{fig:original} shows how class 1 and 2 overlap affecting both model's accuracy and performance.
However, both models still achieved decent overall results.
The GMM model achieved an overall accuracy of 85.24\% which is not that far off
from the LDA's performance of 88.28\%. This shows that unsupervised learning can discover
meaningful insights from the data and pick up the latent structure of the data even without
using true labels.
